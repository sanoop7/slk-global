          ...
          >
            <div className="content-container">
              <ScrollAnimation animateIn="fadeIn">
                <div className="content-section">
                  <div className="section-text">
                    ...
                    and gas majors, and commercial clients globally. In order to
                    integrate and accelerate supply chains in challenging
                    conditions across numerous geographies, our core business is
                    concentrated on developing progressive resources,
                    capabilities, and technology. By choosing the best products
                    from the best suppliers and delivering them at the correct
                    time, we assist our clients in achieving their business
                    goals. As a major player in the consumer goods, automotive,
                    construction, and perishable industries, we have extensive
                    knowledge of these sectors. With offices in the United Arab
                    Emirates, the United States, Poland, Singapore, Qatar, Iraq,
                    India, Spain, and Romania, we serve demographics all over
                    the world, including those in the USA, Europe, Africa, the
              ...
              <div className="content-section content-section_2">
                ...
                <div className="section-text">
                  We immerse our specialists in the client's business and use
                  the best talent to fully comprehend their needs. This makes it
                  possible for us to create a unique and cohesive buying
                  strategy with various suppliers, carry out effective sourcing
                  initiatives, and quickly spread shipping knowledge to various
                  clients.
                </div>
              </div>
              <div className="section-vision">
                ...
                <div className="mission-cont">
                  ...
                  <div className="section-desc">
                    Our mission is to be recognised as the leading procurement,
                    logistics, and subcontracting firm in the industry by
                    consistently delivering exceptional service and value to our
                    clients. Through our expertise and commitment to excellence,
                    we strive to empower our clients to achieve sustainable
                    competitive advantage. We work to raise industry standards,
                    especially those relating to partner and client interaction,
                    and foster better operations that integrate best practices
