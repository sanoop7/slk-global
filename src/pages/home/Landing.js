  ...
  return (
    <>
      <div className="Landing_cont">
        ...
        >
          <div className={`slider_head ${activeSlide === 1 && "active_head"}`}>
            ...
            <div className="slide_desc">
              <span>
                Dedicated to national security, we empower our military through
                advanced procurement, ensuring a safer future for our nation.
              </span>
        ...
        >
          <div className={`slider_head ${activeSlide === 2 && "active_head"}`}>
            <h1>Oil & Gas</h1>
            <span className="slider_sub">
        ...
        >
          <div className={`slider_head ${activeSlide === 3 && "active_head"}`}>
            <h1>About Us</h1>
            <span className="slider_sub">
